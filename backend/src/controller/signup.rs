use axum::{extract::State, http::StatusCode, routing::{get, post}, Form, Router};
use maud::{html, Markup};
use tracing::info;

use crate::{appstate::AppState, model::{users::User, DatabaseComponent}, views::signup::{email_form_html, signup_failure, signup_page, signup_success}};
